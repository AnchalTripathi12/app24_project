        ...
        <table class="admin-batch-tableOuter">
            <thead>
                <tr>
                    ...
                    <th class="admin-batch-tableHead" colspan="3" >Fathername</th>
                    <th class="admin-batch-tableHead"  colspan="3" >dob</th>
                    <th class="admin-batch-tableHead" colspan="3" >email</th>
                    <th class="admin-batch-tableHead" colspan="3" >address</th>
...
?>
 <tr>
                    ...
                    <td class="admin-batch-tableData"  colspan="3"><?= $record['fname']?> </td>
                    <td class="admin-batch-tableData"  colspan="3"><?= $record['dob']?></td>
                    <td class="admin-batch-tableData"  colspan="3"><?= $record['email']?></td>
                    <td class="admin-batch-tableData"  colspan="3"><?= $record['address']?></td>
