...
.admin-batch-buttonIcon {
    ...
    <script>
        const AnchalFail = (ID) => {
            const conf = confirm(" linkedin wale, Are you kutta");
            if(conf){
                window.location.href = `delete.php?id=${ID}`;
            }else{
                alert("hum santosh pagal na hai");
            }
        ...
        <table class="admin-batch-tableOuter">
            <thead>
                <tr>
                    ...
                    <th class="admin-batch-tableHead" colspan="3" >First Name</th>
                    <th class="admin-batch-tableHead" colspan="3" >Last Name</th>
                    <th class="admin-batch-tableHead">Phone</th>
                    <th class="admin-batch-tableHead" colspan="3" >Email Id</th>
            ...
            ?>
                <tr>
                    ...
                    <td class="admin-batch-tableData"  colspan="3">
                    <button onclick="AnchalFail(<?= $record['id']?>)">Delete</button>
                    </td>
                </tr>
